...
class GraphWin(tk.Canvas):
    ...
    def __init__(self, title="Graphics Window",
        ...
        master.geometry("{}x{}+{}+{}".format(width,height,GetSystemMetrics(0)//5,GetSystemMetrics(1)//6))
        self.pack()
...
class Text(GraphicsObject):
    ...
    def setFace(self, face):
        if face in ['Gill Sans MT Ext Condensed Bold','Bodoni MT Condensed','Edingu Demo','Calibri','Consolas','Gill Sans MT Condensed','Franklin Gothic Demi Cond','Bernard MT Condensed','Major Mono Display','Gloucester MT Extra Condensed','helvetica','arial','Karma Future','Player 1 Up Black','Frostbite Boss Fight','All the Way to the Sun','Slope Opera','Bahnschrift SemiLight Condensed','Azonix','SNES','Sportypo','Botsmatic Outline','Black And White Display','courier','Cooper Black','Product Sans Light','PT Sans Narrow','Product Sans Medium','PT Sans','ProductSans-Black','times roman','Berlin Sans FB','Argon Light','Argon']:
    ...
    def setStyle(self, style):
        if style in ['bold','normal','italic', 'bold italic', 'underline']:
            f,s,b = self.config['font']
...
class Entry(GraphicsObject):
    ...
    def setBorderWidth(self, borders):
        self.borders = borders
        if self.entry:
            self.entry.config(borderwidth = borders)

    def setCursor(self,cursors):
        self.cursors = cursors
        if self.entry:
            self.entry.config(cursor = cursors)
    ...
    def setFace(self, face):
        if face in ['Gill Sans MT Ext Condensed Bold','Bodoni MT Condensed','Edingu Demo','Caliri','Consolas','Gill Sans MT Condensed','Franklin Gothic Demi Cond','Bernard MT Condensed','Major Mono Display','Gloucester MT Extra Condensed','helvetica','arial','Karma Future','Player 1 Up Black','Frostbite Boss Fight','All the Way to the Sun','Slope Opera','Bahnschrift SemiLight Condensed','Azonix','SNES','Sportypo','Botsmatic Outline','Black And White Display','courier','Cooper Black','Product Sans Light','PT Sans Narrow','Product Sans Medium','PT Sans','ProductSans-Black','times roman','Berlin Sans FB','Argon Light','Argon']:
